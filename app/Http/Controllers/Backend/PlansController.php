...
use App\Http\Requests\Plans\PlanUpdate;
...
class PlansController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboard.payments.plans.form', compact('plan'));
    }
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function update(string $id, PlanUpdate $request)
    {
        $plan = $this->plan->retrieve($id);
        ...
        Alert::success('Plan successfully updated')->flash();
