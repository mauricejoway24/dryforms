<template>
    <b-modal v-model="show" :title="modalTitle" class="cancel-subscription"
        ...
        <p class="float-center mb-1">
            Confirmation of this statement will cancel your subscription what will lead to unavailability to use our
            service. All employees of your company will remain valid till the end of their payed period.
        </p>
